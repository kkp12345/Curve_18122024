...
def update_model():
    ...
    output_file_path = 'D:/_July2024/AparProj-2/Code30072024/CaliCode01/Predicted_Temperature.csv'
    output_data.to_csv(output_file_path, index=False)
    print(f"Model coefficients and predictions saved to {output_file_path}")
